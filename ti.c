...
bool player_colide_potion(Player player, Potion potion){
    ...
    // Debug visualization
    DrawRectangleLines(potion_rec.x, potion_rec.y, potion_rec.width, potion_rec.height, LIME);
    DrawRectangleLines(player_rec.x, player_rec.y, player_rec.width, player_rec.height, PINK);
